                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="RegisterController.php" method="post" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="passwordRepeat" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Repeat Password">
                                    </div>
                                </div>
                                <input class="btn btn-primary btn-user btn-block" name="register" type="submit" value="Register" />
                            </form>
                            <hr>
                            <div class="text-center">
